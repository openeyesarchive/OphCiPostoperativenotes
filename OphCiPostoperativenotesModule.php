...
class OphCiPostoperativenotesModule extends BaseEventTypeModule
{
	...
	public function init()
	{
		...
		$this->setImport(array(
			'OphCiPostoperativenotes.models.*',
			'OphCiPostoperativenotes.components.*',
		));

		$this->moduleShortSuffix = "postoperativenotes";
	}
