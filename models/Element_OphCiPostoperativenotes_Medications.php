...
/**
 * This is the model class for table "et_ophcipostoperativenotes_medications".
 *
...
class Element_OphCiPostoperativenotes_Medications extends BaseEventTypeElement
{
	public $service;
	public $placeholder;
	...
	{
		return 'et_ophcipostoperativenotes_medications';
	}
	...
	protected function afterSave()
	{
		...
		if (!empty($_POST['medication_id'])) {
			foreach ($_POST['medication_id'] as $i => $medication_id) {
				if (!$medication = OphCiPostoperativenotes_Medication_Item::model()->find('element_id=? and medication_id=?',array($this->id,$medication_id))) {
					$medication = new OphCiPostoperativenotes_Medication_Item;
					$medication->element_id = $this->id;
					$medication->medication_id = $medication_id;
				}
		...
		OphCiPostoperativenotes_Medication_Item::model()->deleteAll($criteria);
