...
/**
 * This is the model class for table "ophcipostoperativenotes_gas".
 *
...
class OphCiPostoperativenotes_Gas extends BaseActiveRecordVersionedSoftDelete
{
	...
	{
		return 'ophcipostoperativenotes_gas';
	}
	...
	public function relations()
	{
		...
		return array(
			'fieldType' => array(self::BELONGS_TO, 'OphCiPostoperativenotes_Gas_Field_Type', 'field_type_id'),
		);
	}
