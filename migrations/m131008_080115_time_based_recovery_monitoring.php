...
class m131008_080115_time_based_recovery_monitoring extends OEMigration
{
	...
	public function down()
	{
		...
		$this->addColumn('et_ophcipostoperativenotes_recovery_monitoring','o2_lmin','varchar(255)');
		$this->addColumn('et_ophcipostoperativenotes_recovery_monitoring','temp','varchar(255)');
		$this->addColumn('et_ophcipostoperativenotes_recovery_monitoring','pain_score','int(10) unsigned NOT NULL');
		$this->addColumn('et_ophcipostoperativenotes_recovery_monitoring','nausea_vomiting','varchar(255)');
		$this->addColumn('et_ophcipostoperativenotes_recovery_monitoring','blood_loss','varchar(255)');
		$this->addColumn('et_ophcipostoperativenotes_recovery_monitoring','mews_score','varchar(255)');
	}
}
